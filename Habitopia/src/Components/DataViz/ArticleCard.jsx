  ...
  return (
    <div>
      ...
      <div className='text-white'>
        <Reply prompt={"this is my habit: "+habit.habitName+". This is the description of my habit:"+habit.desc+". This is the purpose of my habit: "+habit.purpose+". Give me a short 150 word article on how I should start and continue this habit, benefits of this habit, how to keep consistency etc. DO NOT DO ANY FORMATTING OR BOLDS OR POINTS OR NUMBERING. SINGLE PARAGRAPH TYPE."} /> 
        </div>
    </div>
  )
}
